...
func sampleNetworks() []KnownNetwork {
	return []KnownNetwork{
		{SSID: "nikolatesla2", Security: "wpa2-psk", DNSMode: DNSModeDNSCrypt,
			MACMode: MACModeStable, AutoConnect: true, Signal: 92, Connected: true},
		{SSID: "Berners-Lee2.4", Security: "wpa2-psk", DNSMode: DNSModeCloudflare,
			MACMode: MACModeRandom, Signal: 65},
		{SSID: "TP-Link_895F_5G", Security: "wpa2-eap", DNSMode: DNSModeDHCP,
